...
INSERT INTO post(title,description,author_id,photo,post_date,likes,dislikes,longitude,latitude)VALUES('Avengers Infinity War release on April 26th','Theres a reason that all of Marvels heroes have to come together in Infinity War, and his name is Thanos',1,LOAD_FILE('file:/E:/ProjekatOSANews/news/target/classes/images/avengers1.png'),'2018-03-26 19:03:21',25,6,19.833549,45.267136);
INSERT INTO post(title,description,author_id,photo,post_date,likes,dislikes,longitude,latitude)VALUES('Deadpool 2 release on May 18th','Deadpool 2, the Ryan Reynolds-led sequel, is on pace to open to a huge $150 million in North America this summer',2,NULL,'2018-04-15 09:45:33',30,4,20.457273,44.787197);
INSERT INTO post(title,description,author_id,photo,post_date,likes,dislikes,longitude,latitude)VALUES('Amazing victory of Liverpool','Liverpool ran riot against AS Roma in the first leg of the Champions League semi-final to clinch a 5-2 win at Anfield',3,NULL,'2018-04-26 16:36:24',23,5,19.3166654,45.3499986);
...
INSERT INTO comment(comm_title,comm_description,comm_date,comm_likes,comm_dislikes,post_id,author_id)VALUES('Movie ','Its going to be fun','2018-03-27 13:24:52',18,3,1,3);
